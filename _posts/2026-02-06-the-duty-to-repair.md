---
layout: post
title: "The Duty to Repair: Why Your Devices are Finally Yours Again"
subtitle: "In 2026, the 'sealed black box' is a relic of the past. Here's how we won the war on planned obsolescence."
date: 2026-02-06
description: "An exploration of the shift from disposable gadgets to durable, repairable hardware in the mid-2020s."
---
...
![The intricate beauty of the hardware we are now allowed to fix.](https://images.unsplash.com/photo-1597733336794-12d05021d510?auto=format&fit=crop&q=80&w=1000)
...
```mermaid
graph LR
    subgraph "Linear Economy (2010-2023)"
    A[Buy] --> B[Use]
    B --> C[Break]
    C --> D[Landfill]
    end
    subgraph "Circular Economy (2026)"
    E[Buy] --> F[Use]
    F --> G[Break]
    G --> H[Repair]
    H --> F
...
It’s the hardware equivalent of the [Tactile Manifesto]({% post_url 2026-02-04-the-tactile-manifesto %}). We want to *see* how the thing works. We want to know that if the charging port wears out—as all physical ports eventually do—we can swap it for $15 instead of buying a new motherboard for $600.
